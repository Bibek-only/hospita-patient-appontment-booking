        ...
        <div classname="overflow-hidden bg-white rounded-md shadow-md">
            <div classname="px-4 py-6 sm:px-8 sm:py-7">
                <div classname="text-center">
                    ...
                    <p classname="mt-2 text-base text-gray-600">Already joined? <a href="#" title="" classname="text-blue-600 transition-all duration-200 hover:underline hover:text-blue-700">Sign in now</a></p>
                </div>
